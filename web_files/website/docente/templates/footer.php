    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo $url_base; ?>sections/close.php">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo $url_base; ?>js/sb-admin-2.min.js"></script>

<!-- Page level plugins -->
<script src="<?php echo $url_base; ?>chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?php echo $url_base; ?>js/demo/chart-area-demo.js"></script>
<script src="<?php echo $url_base; ?>js/demo/chart-pie-demo.js"></script>
...
<!-- Page level custom scripts -->
<script src="<?php echo $url_base; ?>js/demo/datatables-demo.js"></script>
