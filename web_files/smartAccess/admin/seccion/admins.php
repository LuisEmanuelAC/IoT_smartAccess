...
switch ($accion) {
    case "Agregar":
        $sql = "INSERT INTO usuarios (nombre, correo, contrasena, tipo_u) VALUES ('$usua_txtNombre', '$usua_txtCorreo', '$usua_txtContr', '$usua_txtTurno', 'admin')";
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" value="<?php echo $usua_txtNombre; ?>"
                        name="usua_txtNombre" id="usua_txtNombre" placeholder="Nombre Alumno">
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Correo alumno:</label>
                    <input type="text" required class="form-control" value="<?php echo $usua_txtCorreo; ?>"
                        name="usua_txtCorreo" id="usua_txtCorreo" placeholder="Correo Alumno">
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Contraseña alumno:</label>
                    <input type="text" required class="form-control" value="<?php echo $usua_txtContr; ?>"
                        name="usua_txtContr" id="usua_txtContr" placeholder="Contraseña Alumno">
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Turno alumno:</label>
                    <select required name="usua_txtTurno" id="usua_txtTurno" class="form-select form-select-sm"
                        ...
                        <option value="dTurnos" <?php if($usua_txtTurno == 'dTurnos') echo 'selected'; ?>>Dos turnos
                        </option>
                    </select>
                </div>
                ...
                <div class="btn-group" role="group" aria-label="">
                    <button type="submit" name="accion" <?php echo ($accion=="Seleccionar")?"disabled":""; ?>
                        value="Agregar" class="btn btn-success">Agragar</button>
                    <button type="submit" name="accion" <?php echo ($accion!="Seleccionar")?"disabled":""; ?>
